...
export const couponActionsTotal = new client.Counter({
  name: "coupon_actions_total",
  help: "Coupon action operations by action and result",
...
export const observeCouponAction = ({ action, result }) => {
  couponActionsTotal.inc({ action, result });
};
